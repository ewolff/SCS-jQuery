...
- Go to directory `scs-demo-jquery` and run `mvn package` there
...
- You can access the order SCS at http://ipadresss:8081/ . It goes
to the order SCS.
- You can access the catalog SCS at http://ipadresss:8081/catalog .
